...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btnErase, btnPlus, btnMinus, btnDivide, btnMultiply, btnClear, btnEquals, btnDot;
    ...
    private void checkOperationOrder(Button button) {
        ...
        if(!(string.isEmpty()) && (!substring.contentEquals(btnPlus.getText())) && (!substring.equals(btnMinus.getText())) && (!substring.equals(btnMultiply.getText())) && (!substring.equals(btnDivide.getText())) && (!substring.contentEquals(btnDot.getText())) ){
